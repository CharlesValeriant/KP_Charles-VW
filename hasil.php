...
<head>
    ...
    <title>Periksakan Kucingmu!</title>
</head>
<body>
    <nav class="navbar py-2 navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="#"
            ><img src="gambar/kucing.jpg" width="147" alt="logo"
            /></a>
            <button
        ...
        <div class="container">
            <div class="row">
                <div class="col align-self-center">
                    <h3 class="mb-4">Penyakit yang kucing anda alami : </h3>
                    <?php
                        if(isset($_SESSION)) {
                    ...
                    <h5 class="mb-4">
                        <div class="py-1">
                            <strong>
                            Distamper Kucing = <?= $_SESSION['ginjalAkut']; ?>%
                            </strong>
                        </div>
                        <div class="py-1">
                            <strong>
                            Kutu Kucing = <?= $_SESSION['ginjalKronis']; ?>%
                            </strong>
                        </div>
                        <div class="py-1">
                            <strong>
                            Ring worm = <?= $_SESSION['batuGinjal']; ?>%
                            </strong>
                        </div>
                        <div class="py-1">
                            <strong>
                            Infeksi Pernafasan = <?= $_SESSION['infeksiGinjal']; ?>%
                            </strong>
                        </div>
                        <div class="py-1">
                            <strong>
                            Infeksi Mata = <?= $_SESSION['kankerGinjal']; ?>%
                            </strong>
                        </div>
                        <div class="py-1">
                            <strong>
                            Corona Virus = <?= $_SESSION['gagalGinjal']; ?>%
                            </strong>
                        </div>
